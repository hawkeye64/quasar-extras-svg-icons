...
const menu = [
  {
    name: 'All about quasar-extras-svg-icons',
    path: 'all-about-quasar-extras-svg-icons',
    expanded: false,
    children: [
      {
        name: 'What is quasar-extras-svg-icons',
        path: 'what-is-quasar-extras-svg-icons'
      },
      {
    ...
    children: [
      {
        name: 'GitHub',
        external: true,
        path: 'https://github.com/hawkeye64/quasar-extras-svg-icons',
        rightIcon: biGithub
      },
      {
        name: 'Twitter',
