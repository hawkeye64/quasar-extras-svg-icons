...
desc: Contribution areas where help is especially useful
keys: contributing
---
...
- Help reduce package or docs bundle size without weakening discoverability.

If you take on a larger change, please open an issue first so we can avoid duplicated effort.
