...
| [Simple Icons v14](https://simpleicons.org/)                                                          |       14.8.0 | `quasar-extras-svg-icons/simple-icons-v14`        | `sim`                                                                                      | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md)                           |
...
| [Vaadin Icons v24](https://vaadin.com/components/vaadin-icons) | 25.6.5 | `quasar-extras-svg-icons/vaadin-icons-v24` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
