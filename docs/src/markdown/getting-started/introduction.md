...
| [Carbon Icons v11](https://github.com/carbon-design-system/carbon/tree/main/packages/icons)           |      11.55.0 | `quasar-extras-svg-icons/carbon-icons-v11`        | `carbon`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license)               |
...
| [Carbon Pictograms v12](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms) |      12.46.0 | `quasar-extras-svg-icons/carbon-pictograms-v12`   | `carpic`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Country Flag Icons](https://flagicons.lipis.dev/)                                                    |       1.5.18 | `quasar-extras-svg-icons/country-flag-icons`      | `flag`                                                                                     | [License](https://github.com/lipis/flag-icons/blob/main/LICENSE)                                          |
...
| [Maki Icons (Mapbox) v8](https://github.com/mapbox/maki)                                              |        8.1.0 | `quasar-extras-svg-icons/maki-icons-v8`           | `maki`                                                                                     | [License](https://github.com/mapbox/maki/blob/main/LICENSE.txt)                                           |
