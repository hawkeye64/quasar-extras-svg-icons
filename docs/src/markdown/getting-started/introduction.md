...
| [Carbon Icons v11](https://github.com/carbon-design-system/carbon/tree/main/packages/icons)           |      11.54.0 | `quasar-extras-svg-icons/carbon-icons-v11`        | `carbon`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license)               |
...
| [Carbon Pictograms v12](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms) |      12.45.0 | `quasar-extras-svg-icons/carbon-pictograms-v12`   | `carpic`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Country Flag Icons](https://flagicons.lipis.dev/)                                                    |       1.5.16 | `quasar-extras-svg-icons/country-flag-icons`      | `flag`                                                                                     | [License](https://github.com/lipis/flag-icons/blob/main/LICENSE)                                          |
...
| [Fluent UI System Icons](https://github.com/microsoft/fluentui-system-icons)                          |      1.1.274 | `quasar-extras-svg-icons/fluentui-system-icons`   | `fui`                                                                                      | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE)                         |
...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/)                             |      3.123.0 | `quasar-extras-svg-icons/gitlab-icons-v3`         | `gitlab`                                                                                   | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE)                                  |
...
| [Keyrune Icons](https://github.com/andrewgioia/keyrune)                                               |       3.16.1 | `quasar-extras-svg-icons/keyrune-icons`           | `keyrune`                                                                                  | [License](https://github.com/andrewgioia/keyrune/blob/master/LICENSE.md)                                  |
...
| [Material Icon Theme v5](https://github.com/material-extensions/vscode-material-icon-theme)           |       5.19.0 | `quasar-extras-svg-icons/material-icon-theme-v5`  | `matTheme`                                                                                 | [License](https://github.com/line-md/blob/master/license.txt)                                             |
...
| [Octicons (Primer) v19](https://primer.style/octicons/)                                               |      19.15.0 | `quasar-extras-svg-icons/oct-icons-v19`           | `oct`                                                                                      | [License](https://github.com/primer/octicons/blob/main/LICENSE)                                           |
...
| [Simple Icons v14](https://simpleicons.org/)                                                          |       14.5.0 | `quasar-extras-svg-icons/simple-icons-v14`        | `sim`                                                                                      | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md)                           |
...
| [Tabler Icons v3](https://tabler-icons.io) | 3.30.0 | `quasar-extras-svg-icons/tabler-icons-v3` | `tab`, `tabBrand` | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE) |
| Tabler Icons v2 | 2.42.0 | `quasar-extras-svg-icons/tabler-icons-v2` | `tab`, `tabBrand` | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE) |
...
| [Vaadin Icons v24](https://vaadin.com/components/vaadin-icons) | 24.6.4 | `quasar-extras-svg-icons/vaadin-icons-v24` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
...
<script setup>
  ...
  'quasar-extras-svg-icons/remix-icons'; const $q = useQuasar(); $q.iconSet.expansionItem.icon =
  remArrowDownCircleFill;
</script>
```
