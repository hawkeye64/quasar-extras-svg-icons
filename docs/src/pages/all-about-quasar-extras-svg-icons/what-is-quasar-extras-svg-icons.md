...
| [Carbon Icons](https://github.com/carbon-design-system/carbon/tree/main/packages/icons)                           |      11.29.2 | `quasar-extras-svg-icons/carbon-icons-v11`        | `carbon`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license)               |
...
| [Carbon Pictograms](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms)                 |      12.25.2 | `quasar-extras-svg-icons/carbon-pictograms-v12`   | `carpic`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Fluent UI System Icons](https://github.com/microsoft/fluentui-system-icons)                                      |      1.1.222 | `quasar-extras-svg-icons/fluentui-system-icons`   | `fui`                                                                                      | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE)                         |
...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/)                                         |       3.69.0 | `quasar-extras-svg-icons/gitlab-icons-v3`         | `gitlab`                                                                                   | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE)                                  |
...
| [Iconoir Icons v7](https://github.com/lucaburgio/iconoir)                                                         |        7.0.0 | `quasar-extras-svg-icons/iconoir-icons-v7`        | `ico`                                                                                      | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE)                                      |
...
| [Keyrune Icons](https://github.com/andrewgioia/keyrune)                                                           |       3.12.3 | `quasar-extras-svg-icons/keyrune-icons`           | `keyrune`                                                                                  | [License](https://github.com/andrewgioia/keyrune/blob/master/LICENSE.md)                                  |
...
| [Material Line Icons](https://cyberalien.github.io/line-md/)                                                      |       0.2.14 | `quasar-extras-svg-icons/material-line-icons`     | `matLine`                                                                                  | [License](https://github.com/cyberalien/line-md/blob/master/license.txt)                                  |
...
| [Simple Icons v9](https://simpleicons.org/)                                                                       |       9.16.0 | `quasar-extras-svg-icons/simple-icons-v9`         | `sim`                                                                                      | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md)                           |
...
| [Tabler Icons](https://tabler-icons.io)                                                                           |       2.38.0 | `quasar-extras-svg-icons/tabler-icons-v2`         | `tab`, `tabBrand`                                                                          | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE)                                     |
...
| [Vaadin Icons v24](https://vaadin.com/components/vaadin-icons)                                                    |       24.1.6 | `quasar-extras-svg-icons/vaadin-icons-v24`        | `vaadin`                                                                                   | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE)                                     |
