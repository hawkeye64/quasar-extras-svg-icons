...
| [Fluent UI System Icons](https://github.com/microsoft/fluentui-system-icons)                                      |      1.1.218 | `quasar-extras-svg-icons/fluentui-system-icons`   | `fui`                                                                                      | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE)                         |
...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/)                                         |       3.65.0 | `quasar-extras-svg-icons/gitlab-icons-v3`         | `gitlab`                                                                                   | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE)                                  |
