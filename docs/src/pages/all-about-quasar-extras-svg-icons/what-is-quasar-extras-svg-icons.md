...
| [Clarity Icons (@cds/core) v6](https://github.com/vmware/clarity) | 6.2.5 | `quasar-extras-svg-icons/clarity-icons-v6` | `clarity` | [License](https://github.com/vmware/clarity#licenses) |
...
| [Fluent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.193 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 3.18.0 | `quasar-extras-svg-icons/gitlab-icons-v3` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
...
| [Hero Icons v2](https://heroicons.com/) | 2.0.14 | `quasar-extras-svg-icons/hero-icons-v2` | `heroOutline`, `heroSolid` | [License](https://github.com/tailwindlabs/heroicons/blob/master/LICENSE) |
...
| [Iconoir Icons v6](https://github.com/lucaburgio/iconoir) | 6.2.0 | `quasar-extras-svg-icons/iconoir-icons-v6` | `ico` | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE) |
