...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 3.31.0 | `quasar-extras-svg-icons/gitlab-icons-v3` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
...
| [Hero Icons v2](https://heroicons.com/) | 2.0.16 | `quasar-extras-svg-icons/hero-icons-v2` | `heroOutline`, `heroSolid` | [License](https://github.com/tailwindlabs/heroicons/blob/master/LICENSE) |
...
| [Iconoir Icons v6](https://github.com/lucaburgio/iconoir) | 6.4.1 | `quasar-extras-svg-icons/iconoir-icons-v6` | `ico` | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE) |
...
| [IconPark Icons](https://github.com/bytedance/IconPark) | 1.0.0 | `quasar-extras-svg-icons/iconpark-icons` | `ip` | [License](https://github.com/bytedance/IconPark/blob/master/LICENSE) |
| [IconPark Icons](https://github.com/bytedance/IconPark) | 1.0.0 | `quasar-extras-svg-icons/iconpark-icons` | `ip` | [License](https://github.com/bytedance/IconPark/blob/master/LICENSE) |
| [Icons Material (mui)](https://github.com/mui/material-ui/tree/master/packages/mui-icons-material/material-icons) | 5.11.11 | `quasar-extras-svg-icons/icons-material` | `imat` | [License](https://github.com/mui/material-ui/blob/master/LICENSE) |
...
| [Simple Icons v8](https://simpleicons.org/) | 8.8.0 | `quasar-extras-svg-icons/simple-icons-v8` | `sim` | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md) |
...
| [Tabler Icons](https://tabler-icons.io) | 2.11.0 | `quasar-extras-svg-icons/tabler-icons-v2` | `tab`, `tabBrand` | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE) |
