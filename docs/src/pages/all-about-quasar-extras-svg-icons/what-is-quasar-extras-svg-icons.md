...
| --- | ---: | --- | --- | --- |
| [Akar Icons](https://github.com/artcoholic/akar-icons) | 1.9.17 | `quasar-extras-svg-icons/akar-icons` | `akar` | [License](https://github.com/artcoholic/akar-icons/blob/master/LICENSE)|
...
| [Carbon Icons](https://github.com/carbon-design-system/carbon/tree/main/packages/icons) | 11.3.0 | `quasar-extras-svg-icons/carbon-icons-v11` | `carbon` | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license) |
...
| [Carbon Pictograms](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms) | 12.1.0 | `quasar-extras-svg-icons/carbon-pictograms-v12` | `carpic` | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Clarity Icons (@cds/core) v6](https://github.com/vmware/clarity) | 6.0.0 | `quasar-extras-svg-icons/clarity-icons-v6` | `clarity` | [License](https://github.com/vmware/clarity#licenses) |
...
| [Codicons (vscode)](https://github.com/microsoft/vscode-codicons) | 0.0.30 | `quasar-extras-svg-icons/condicons` | `codi` | [License](https://github.com/microsoft/vscode-codicons/blob/main/LICENSE) |
...
| [Country Flag Icons](https://flagicons.lipis.dev/) | 1.4.26 | `quasar-extras-svg-icons/country-flag-icons` | `flag` | [License](https://github.com/lipis/flag-icons/blob/main/LICENSE) |
| [Dashicons](https://github.com/WordPress/dashicons) | 0.9.0 | `quasar-extras-svg-icons/dashicons` | `dash` | [License](https://github.com/WordPress/dashicons/blob/master/gpl.txt) |
...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.170 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Gitlab Icons](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 2.14.0 | `quasar-extras-svg-icons/gitlab-icons` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
...
| [Hero Icons](https://heroicons.com/) | 1.0.6 | `quasar-extras-svg-icons/hero-icons` | `heroOutline`, `heroSolid` | [License](https://github.com/tailwindlabs/heroicons/blob/master/LICENSE) |
...
| [Iconoir Icons](https://github.com/lucaburgio/iconoir) | 4.9.1 | `quasar-extras-svg-icons/iconoir-cons-v4` | `ico` | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE) |
| [Iconoir Icons](https://github.com/lucaburgio/iconoir) | 1.0.0 | `quasar-extras-svg-icons/iconoir-icons` | `ico` | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE) |
...
| [Icons Material (mui)](https://github.com/mui/material-ui/tree/master/packages/mui-icons-material/material-icons) | 5.6.2 | `quasar-extras-svg-icons/icons-material` | `imat` | [License](https://github.com/mui/material-ui/blob/master/LICENSE) |
...
| [Keyrune Icons](https://github.com/andrewgioia/keyrune) | 3.10.0 | `quasar-extras-svg-icons/keyrune-icons` | `keyrune` | [License](https://github.com/andrewgioia/keyrune/blob/master/LICENSE.md) |
...
| [Material Line Icons](https://cyberalien.github.io/line-md/) | 0.2.0 | `quasar-extras-svg-icons/material-line-icons` | `matLine` | [License](https://github.com/cyberalien/line-md/blob/master/license.txt) |
...
| [Octicons (Primer) v17](https://primer.style/octicons/) | 17.2.0 | `quasar-extras-svg-icons/oct-icons-v17` | `oct` | [License](https://github.com/primer/octicons/blob/main/LICENSE) |
...
| [Simple Icons](https://simpleicons.org/) | 6.22.0 | `quasar-extras-svg-icons/simple-icons` | `sim` | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md) |
...
| [Tabler Icons](https://tabler-icons.io) | 1.68.0 | `quasar-extras-svg-icons/tabler-icons` | `tab`, `tabBrand` | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE) |
...
| [Vaadin Icons v23](https://vaadin.com/components/vaadin-icons) | 23.0.10 | `quasar-extras-svg-icons/vaadin-icons-v23` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
| [Vaadin Icons](https://vaadin.com/components/vaadin-icons) | 22.0.6 | `quasar-extras-svg-icons/vaadin-icons` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
