...
| [Carbon Icons v11](https://github.com/carbon-design-system/carbon/tree/main/packages/icons)           |      11.53.0 | `quasar-extras-svg-icons/carbon-icons-v11`        | `carbon`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license)               |
...
| [Carbon Pictograms v12](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms) |      12.43.0 | `quasar-extras-svg-icons/carbon-pictograms-v12`   | `carpic`                                                                                   | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Clarity Icons (@cds/core) v6](https://github.com/vmware/clarity)                                     |       6.14.0 | `quasar-extras-svg-icons/clarity-icons-v6`        | `clarity`                                                                                  | [License](https://github.com/vmware/clarity#licenses)                                                     |
...
| [Country Flag Icons](https://flagicons.lipis.dev/)                                                    |       1.5.13 | `quasar-extras-svg-icons/country-flag-icons`      | `flag`                                                                                     | [License](https://github.com/lipis/flag-icons/blob/main/LICENSE)                                          |
...
| [Fluent UI System Icons](https://github.com/microsoft/fluentui-system-icons)                          |      1.1.266 | `quasar-extras-svg-icons/fluentui-system-icons`   | `fui`                                                                                      | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE)                         |
...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/)                             |      3.122.0 | `quasar-extras-svg-icons/gitlab-icons-v3`         | `gitlab`                                                                                   | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE)                                  |
...
| [Health Icons v1](https://healthicons.org/)                                                           |        1.0.2 | `quasar-extras-svg-icons/health-icons`            | `health`                                                                                   | [License](https://github.com/resolvetosavelives/healthicons/blob/main/LICENSE)                            |
...
| [Hero Icons v2](https://heroicons.com/)                                                               |        2.1.3 | `quasar-extras-svg-icons/hero-icons-v2`           | `heroOutline`, `heroSolid`                                                                 | [License](https://github.com/tailwindlabs/heroicons/blob/master/LICENSE)                                  |
...
| [Iconoir Icons v7](https://github.com/lucaburgio/iconoir)                                             |        7.6.0 | `quasar-extras-svg-icons/iconoir-icons-v7`        | `ico`                                                                                      | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE)                                      |
...
| [Material Line Icons v1](https://cyberalien.github.io/line-md/)                                       |        1.0.5 | `quasar-extras-svg-icons/material-line-icons`     | `matLine`                                                                                  | [License](https://github.com/cyberalien/line-md/blob/master/license.txt)                                  |
...
| [Octicons (Primer) v19](https://primer.style/octicons/)                                               |       19.9.0 | `quasar-extras-svg-icons/oct-icons-v19`           | `oct`                                                                                      | [License](https://github.com/primer/octicons/blob/main/LICENSE)                                           |
...
| [Openmoji Icons v15](https://github.com/hfg-gmuend/openmoji)                                          |       14.0.0 | `quasar-extras-svg-icons/openmoji-icons-v15`      | `om`, `omc`                                                                                | [License](https://github.com/hfg-gmuend/openmoji/blob/master/LICENSE.txt)                                 |
...
| [Polaris (Shopify) Icons v9](https://github.com/Shopify/polaris/tree/main/polaris-icons)              |        9.0.0 | `quasar-extras-svg-icons/polaris-icons-v9`        | `prime`                                                                                    | [License](https://github.com/Shopify/polaris/blob/main/polaris-icons/LICENSE.md)                          |
...
| [Remix Icon v4](https://remixicon.com/)                                                               |        3.6.0 | `quasar-extras-svg-icons/remix-icons-v4`          | `rem`                                                                                      | [License](https://github.com/Remix-Design/RemixIcon/blob/master/License)                                  |
...
| [Simple Icons v11](https://simpleicons.org/)                                                          |       10.0.0 | `quasar-extras-svg-icons/simple-icons-v11`        | `sim`                                                                                      | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md)                           |
| Simple Icons v10                                                                                      |       10.0.0 | `quasar-extras-svg-icons/simple-icons-v10`        | `sim`                                                                                      | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md)                           |
...
| [Tabler Icons v3](https://tabler-icons.io)                                                            |        3.2.0 | `quasar-extras-svg-icons/tabler-icons-v3`         | `tab`, `tabBrand`                                                                          | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE)                                     |
...
| [Vaadin Icons v24](https://vaadin.com/components/vaadin-icons)                                        |      24.3.11 | `quasar-extras-svg-icons/vaadin-icons-v24`        | `vaadin`                                                                                   | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE)                                     |
