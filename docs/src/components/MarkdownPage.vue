      ...
      <div class="markdown-page__footer">
        ...
        <div v-if="path && noEdit !== true">
          <div class="full-width row justify-center items-center">
            ...
            <markdown-link
              :to="'https://github.com/hawkeye64/quasar-extras-svg-icons/edit/main/docs/src/pages' + path + '.md'"
            >
  ...
  setup (props) {
    ...
    useMeta(
      props.metaDesc !== void 0
        ? { title: props.metaTitle, meta: getMeta(props.metaTitle + ' » quasar-extras-svg-icons', props.metaDesc) }
