...
| [Iconoir Icons v7](https://github.com/lucaburgio/iconoir)                                             |       7.10.1 | `quasar-extras-svg-icons/iconoir-icons-v7`        | `ico`                                                                                      | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE)                                      |
...
| [Keyrune Icons](https://github.com/andrewgioia/keyrune)                                               |       3.16.0 | `quasar-extras-svg-icons/keyrune-icons`           | `keyrune`                                                                                  | [License](https://github.com/andrewgioia/keyrune/blob/master/LICENSE.md)                                  |
...
| [Material Line Icons v1](https://cyberalien.github.io/line-md/)                                       |        1.0.6 | `quasar-extras-svg-icons/material-line-icons`     | `matLine`                                                                                  | [License](https://github.com/cyberalien/line-md/blob/master/license.txt)                                  |
...
| [Octicons (Primer) v19](https://primer.style/octicons/)                                               |      19.12.0 | `quasar-extras-svg-icons/oct-icons-v19`           | `oct`                                                                                      | [License](https://github.com/primer/octicons/blob/main/LICENSE)                                           |
