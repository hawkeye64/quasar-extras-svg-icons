...
| [Clarity Icons (@cds/core) v6](https://github.com/vmware/clarity) | 6.3.2 | `quasar-extras-svg-icons/clarity-icons-v6` | `clarity` | [License](https://github.com/vmware/clarity#licenses) |
...
| [GitLab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 3.36.0 | `quasar-extras-svg-icons/gitlab-icons-v3` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
...
| [Hero Icons v2](https://heroicons.com/) | 2.0.17 | `quasar-extras-svg-icons/hero-icons-v2` | `heroOutline`, `heroSolid` | [License](https://github.com/tailwindlabs/heroicons/blob/master/LICENSE) |
...
| [Vaadin Icons v24](https://vaadin.com/components/vaadin-icons) | 24.0.2 | `quasar-extras-svg-icons/vaadin-icons-v24` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
