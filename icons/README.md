...
| --- | ---: | --- | --- | --- |
| [Akar Icons](https://github.com/artcoholic/akar-icons) | 1.9.20 | `quasar-extras-svg-icons/akar-icons` | `akar` | [License](https://github.com/artcoholic/akar-icons/blob/master/LICENSE)|
...
| [Carbon Icons](https://github.com/carbon-design-system/carbon/tree/main/packages/icons) | 11.7.0 | `quasar-extras-svg-icons/carbon-icons-v11` | `carbon` | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license) |
...
| [Carbon Pictograms](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms) | 12.4.0 | `quasar-extras-svg-icons/carbon-pictograms-v12` | `carpic` | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Fluent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.179 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Gitlab Icons v3](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 3.1.0 | `quasar-extras-svg-icons/gitlab-icons-v3` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
...
| [Octicons (Primer) v17](https://primer.style/octicons/) | 17.4.1 | `quasar-extras-svg-icons/oct-icons-v17` | `oct` | [License](https://github.com/primer/octicons/blob/main/LICENSE) |
...
| [Simple Icons](https://simpleicons.org/) | 7.7.0 | `quasar-extras-svg-icons/simple-icons-v7` | `sim` | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md) |
...
| [Tabler Icons](https://tabler-icons.io) | 1.84.1 | `quasar-extras-svg-icons/tabler-icons` | `tab`, `tabBrand` | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE) |
...
| [Vaadin Icons v23](https://vaadin.com/components/vaadin-icons) | 23.1.5 | `quasar-extras-svg-icons/vaadin-icons-v23` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
