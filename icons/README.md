...
| --- | ---: | --- | --- | --- |
| [Akar Icons](https://github.com/artcoholic/akar-icons) | 1.9.16 | `quasar-extras-svg-icons/akar-icons` | `akar` | [License](https://github.com/artcoholic/akar-icons/blob/master/LICENSE)|
...
| [Carbon Pictograms](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms) | 12.0.2 | `quasar-extras-svg-icons/carbon-pictograms-v12` | `carpic` | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/pictograms#-license#-license) |
...
| [Codicons (vscode)](https://github.com/microsoft/vscode-codicons) | 0.0.29 | `quasar-extras-svg-icons/condicons` | `codi` | [License](https://github.com/microsoft/vscode-codicons/blob/main/LICENSE) |
...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.169 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Gitlab Icons](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 2.12.0 | `quasar-extras-svg-icons/gitlab-icons` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
...
| [Keyrune Icons](https://github.com/andrewgioia/keyrune) | 3.9.2 | `quasar-extras-svg-icons/keyrune-icons` | `keyrune` | [License](https://github.com/andrewgioia/keyrune/blob/master/LICENSE.md) |
