...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.145 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Simple Icons](https://simpleicons.org/) | 5.20.0 | `quasar-extras-svg-icons/simple-icons` | `sim` | [License](simple-icons/LICENSE.md) |
