...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.150 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Simple Icons](https://simpleicons.org/) | 5.23.0 | `quasar-extras-svg-icons/simple-icons` | `sim` | [License](simple-icons/LICENSE.md) |
| [Tabler Icons](https://tabler-icons.io) | 1.44.0 | `quasar-extras-svg-icons/tabler-icons` | `tab` | [License](tabler-icons/LICENSE.md) |
| [Teeny Icons](https://teenyicons.com/) | 0.4.1 | `quasar-extras-svg-icons/teeny-icons` | `teeny` | [License](teeny-icons/LICENSE.md) |
