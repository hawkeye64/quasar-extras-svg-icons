...
| [Carbon Icons](https://github.com/carbon-design-system/carbon/tree/main/packages/icons) | 11.0.2 | `quasar-extras-svg-icons/carbon-icons-v11` | `carbon` | [License](https://github.com/carbon-design-system/carbon/tree/main/packages/icons#-license) |
...
| [Clarity Icons (@cds/core)](https://github.com/vmware/clarity) | 5.6.4 | `quasar-extras-svg-icons/clarity-icons` | `clarity` | [License](https://github.com/vmware/clarity#licenses) |
...
| [Country Flag Icons](https://flagicons.lipis.dev/) | 1.4.25 | `quasar-extras-svg-icons/country-flag-icons` | `flag` | [License](https://github.com/lipis/flag-icons/blob/main/LICENSE) |
...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.166 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Gitlab Icons](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/) | 2.8.0 | `quasar-extras-svg-icons/gitlab-icons` | `gitlab` | [License](https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE) |
