...
| Codicons | 0.0.46-24 | `quasar-extras-svg-icons/codicons` | `codi` | 638 |
...
| FluentUI System Icons | 1.1.341 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | 20726 |
...
| GitLab Icons | 3.164.0 | `quasar-extras-svg-icons/gitlab-icons-v3` | `gitlab` | 499 |
...
| Lucide Icons | 1.46.0 | `quasar-extras-svg-icons/lucide-icons` | `lucide` | 2098 |
...
| Oct Icons v19 | 19.36.0 | `quasar-extras-svg-icons/oct-icons-v19` | `oct` | 750 |
...
| Simple Icons | 16.31.0 | `quasar-extras-svg-icons/simple-icons-v16` | `sim` | 3460 |
...
| Tabler Icons | 3.46.0 | `quasar-extras-svg-icons/tabler-icons-v3` | `tabFilled`, `tabOutline` | 6184 |
...
| Vaadin Icons v25 | 25.2.11 | `quasar-extras-svg-icons/vaadin-icons-v25` | `vaadin` | 636 |
