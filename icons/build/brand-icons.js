const packageName = "brand-icons";
const packagePath = "../../packages/brandicons";
const distName = "brand-icons";
const iconSetName = "Brand Icons";
const prefix = "brnd";
const iconPath = "/src/icons/production/brandicons";
const svgPath = "/*.svg";
