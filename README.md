...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.164 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
...
| [Simple Icons](https://simpleicons.org/) | 6.17.0 | `quasar-extras-svg-icons/simple-icons` | `sim` | [License](https://github.com/simple-icons/simple-icons/blob/develop/LICENSE.md) |
...
| [Tabler Icons](https://tabler-icons.io) | 1.63.0 | `quasar-extras-svg-icons/tabler-icons` | `tab`, `tabBrand` | [License](https://github.com/tabler/tabler-icons/blob/master/LICENSE) |
...
| [Vaadin Icons](https://vaadin.com/components/vaadin-icons) | 22.0.4 | `quasar-extras-svg-icons/vaadin-icons` | `vaadin` | [License](https://github.com/vaadin/vaadin-icons/blob/master/LICENSE) |
