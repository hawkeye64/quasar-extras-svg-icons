...
| [Iconoir Icons v5](https://github.com/lucaburgio/iconoir) | 5.3.0 | `quasar-extras-svg-icons/iconoir-icons-v5` | `ico` | [License](https://github.com/lucaburgio/iconoir/blob/master/LICENSE) |
