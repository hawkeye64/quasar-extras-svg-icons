...
| [Fuent UI System Icons](https://github.com/microsoft/fluentui-system-icons) | 1.1.173 | `quasar-extras-svg-icons/fluentui-system-icons` | `fui` | [License](https://github.com/microsoft/fluentui-system-icons/blob/master/LICENSE) |
